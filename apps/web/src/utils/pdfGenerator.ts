...
export function generateAuditPdf(result: AuditResult) {
  ...
  doc.setFontSize(9);
  doc.setFont("helvetica", "bold");
  doc.text("EXPRESS 15-MIN REPAIR & CONSULTATION:", 20, yPos + 7);

  doc.setFontSize(8);
  doc.setFont("helvetica", "normal");
  doc.setTextColor(71, 85, 105);
  doc.text("Founder: Mohit Sikarwar | Phone/WhatsApp: +91 83070 70605 | Email: mohitsikarwar123@gmail.com", 20, yPos + 14);
  ...
  doc.setFontSize(8);
  doc.setFont("helvetica", "normal");
  doc.text("Generated by LeadGuard OS - Revenue & Lead Protection Engine", 15, 285);
