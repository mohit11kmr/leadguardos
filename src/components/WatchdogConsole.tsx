...
import { ShieldAlert, Activity, CheckCircle, AlertOctagon, Bell, Send, RefreshCw, Radio, Server, Check } from 'lucide-react';
    ...
    <div className="rounded-3xl border border-slate-800 bg-slate-900/90 p-6 md:p-8 shadow-xl space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-5">
        ...
        <button
          ...
          className="flex items-center gap-1.5 self-start sm:self-auto rounded-xl bg-red-600 hover:bg-red-500 text-white px-4 py-2 text-xs font-bold uppercase tracking-wider transition-all shadow-md shadow-red-900/30 active:scale-95"
        >
